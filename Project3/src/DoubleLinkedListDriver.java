...
public class DoubleLinkedListDriver extends Application {
	...
	public void start(Stage stage) {
		...
		TitledPane addTitlePane = new TitledPane("Add to List", addPane);
		...
		TitledPane removeTitlePane = new TitledPane("Remove from List", removePane);
		...
		TitledPane retrieveTitlePane = new TitledPane("Retrieve from List (deletes from list)", retrievePane);
		...
		TitledPane mainRadioPane = new TitledPane("Type of Doubly Linked List", retrievePane);
		mainRadioPane.setCollapsible(false);
		mainRadioPane.setMaxWidth(550);
		mainRadioPane.setPadding(new Insets(20, 10, 5, 10));

		HBox getPane = new HBox();
		getPane.getChildren().addAll(getElementLabel, getElementField, getButtons);
		TitledPane getTitlePane = new TitledPane("Get from List (doesn't deletes from list)", getPane);
		...
		TitledPane listTypePane = new TitledPane("Type of lists", radioPane1);
		listTypePane.setCollapsible(false);
		listTypePane.setMaxWidth(550);
		listTypePane.setPadding(new Insets(20, 10, 5, 10));

		TitledPane listAreaPane = new TitledPane("Contents of lists", listPane);
		...
		TitledPane iterPane = new TitledPane("Iterator (upon add, retrieve or remove, restart iterator)", mainIterPane);
		iterPane.setCollapsible(false);
		iterPane.setMaxWidth(550);
		iterPane.setPadding(new Insets(20, 10, 5, 10));

		mainPane.getChildren().addAll(listTypePane, addTitlePane, retrieveTitlePane, getTitlePane, removeTitlePane,
				iterPane, listAreaPane, buttonPane1);
