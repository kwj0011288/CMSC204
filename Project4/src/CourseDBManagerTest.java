...
public class CourseDBManagerTest {
	...
	public void testRead() {
		try {
			...
			assertEquals("CMSC203", dataMgr.get(30504).getCourseID());
			assertEquals("CMSC204", dataMgr.get(30503).getCourseID());
			assertEquals("SC450", dataMgr.get(30503).getRoomNumber());
		} catch (Exception e) {
