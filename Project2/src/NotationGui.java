...
public class NotationGui extends Application {
	...
	public void start(Stage stage) {
		...
		TitledPane convertTitlePane = new TitledPane("Notation Conversion", conversionPane);
		...
		TitledPane evalTitlePane = new TitledPane("Notation Evaluation", evaluationPane);
		evalTitlePane.setCollapsible(false);
		evalTitlePane.setMaxWidth(550);
		evalTitlePane.setPadding(new Insets(20, 10, 5, 10));

		mainPane.getChildren().addAll(convertTitlePane, evalTitlePane, buttonPane1);
